...
ActiveRecord::Schema.define(version: 2020_06_19_080942) do
  ...
  create_table "labels_records", id: false, force: :cascade do |t|
    ...
    t.bigint "record_id", null: false
    t.index ["label_id", "record_id"], name: "index_labels_records_on_label_id_and_record_id"
    t.index ["record_id", "label_id"], name: "index_labels_records_on_record_id_and_label_id"
  end
